...
const AboutSection = () => {
  const stats = [
    { value: "65%", label: "d'urbains ivoiriens ne pratiquent pas assez d'activité physique" },
  ...
  const objectives = [
    {
      icon: Target,
      title: "Mission",
      content: "Démocratiser l'accès au fitness et à la musculation en Côte d'Ivoire en proposant une alternative inclusive et abordable pour tous."
    },
    {
      icon: Eye,
      title: "Vision", 
      content: "Devenir la référence du fitness accessible en Afrique de l'Ouest et inspirer une génération à adopter un mode de vie sain."
    },
    {
      icon: Lightbulb,
      title: "Objectifs",
      content: "Créer un écosystème sportif complet alliant coaching personnalisé, produits locaux bio et événements communautaires fédérateurs."
    }
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="space-y-6 animate-fade-in-up">
            <Card className="bg-card/80 backdrop-blur-sm border-border p-6">
              <CardContent className="space-y-4 p-0">
                <h3 className="text-2xl font-bold text-foreground">Notre Genèse</h3>
                <p className="text-muted-foreground leading-relaxed">
                  GBÔ est né d'une conviction : <strong className="text-primary">le sport doit être accessible à tous</strong>. 
                  Dans un contexte où 65% des urbains ivoiriens ne pratiquent pas assez d'activité physique, 
                  nous proposons une alternative inclusive et abordable.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  Initialement lancé autour des <strong className="text-primary">protéines bio locales</strong>, 
                  GBÔ est aujourd'hui un écosystème sportif complet : coaching certifié, boutique en ligne, 
                  contenus éducatifs et événements fédérateurs.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="space-y-6 animate-fade-in-up delay-300">
                ...
                <div className="text-center space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground px-4">
                      Découvrez l'histoire inspirante de GBÔ et notre mission pour démocratiser le fitness
                    </p>
                  </div>
                </div>
              </div>
            ...
            <Card className="bg-card/80 backdrop-blur-sm border-border">
              <CardContent className="p-6 space-y-4">
                <h3 className="text-xl font-bold text-foreground">Notre Équipe</h3>
                <div className="grid grid-cols-3 gap-4">
                  {[
                    ...
                    <div key={index} className="text-center space-y-2 group hover-scale">
        ...
        <div className="grid md:grid-cols-3 gap-8 animate-fade-in-up">
          {objectives.map((obj, index) => (
            <Card 
              key={index} 
              className="group hover:shadow-neon transition-all duration-300 hover:-translate-y-2 bg-card/80 backdrop-blur-sm border-border hover:border-primary/50"
          ...
          <CardContent className="p-8">
            <div className="text-center space-y-6">
              <h3 className="text-2xl font-bold text-foreground font-broaven">
                Nos <span className="text-primary text-glow">Valeurs Fondamentales</span>
              </h3>
              <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
                {[
                  ...
                  { icon: Lightbulb, label: "Innovation", desc: "Solutions créatives" },
