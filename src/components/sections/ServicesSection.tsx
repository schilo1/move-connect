  ...
  const services = [
    {
      ...
      description:
        "Mise en relation avec coachs certifiés via géolocalisation. Programmes personnalisés : prise de masse, perte de poids, remise en forme.",
      features: [
        "Coachs certifiés",
        "Géolocalisation",
    ...
    },
    {
      ...
      description:
        "Protéines locales bio (moringa, cajou), vêtements sportifs & accessoires, haltères et équipements artisanaux accessibles.",
      features: [
    ...
    },
    {
      ...
      description:
        "Conseils en nutrition & santé, programmes d'entraînement en ligne, articles, vidéos, challenges.",
      features: [
        "Conseils nutrition",
        "Programmes en ligne",
        "Contenu vidéo",
    ...
    },
    {
      ...
      description:
        "Fitness communal (séances en plein air), GBÔR Challenge (défis sportifs collectifs).",
      features: [
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center space-y-4 mb-16 animate-fade-in-up">
          ...
          <h2 className="text-4xl lg:text-5xl font-bold text-foreground font-broaven">
            Un écosystème{" "}
            <span className="text-primary text-glow">complet</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto font-semibold">
            ...
            découvrez tous nos services pour transformer votre approche du
            fitness.
          </p>
        </div>
          ...
          <div className="text-center space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
              {[
                ...
                <div
                  key={index}
                  className="flex flex-col items-center space-y-2 group hover-scale font-broaven"
                >
